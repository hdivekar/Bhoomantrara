...
if(isset($_POST['submit_on_click1'])){
    ...
    $dateTimeVariable = date("Y-m-d H:i:s");
    $query="INSERT INTO `enquiry`( `name`, `email`, `mobile`,`ip_address`,`date_time`) VALUES ('$name','$email','$mobile','$ipaddress','$dateTimeVariable')";
...
mail("chief.saleslead@bhoomantra.com","Bhoomantra",$msg,$headers);    
}
?>