...
$city_name=get_location_name($city_id);
						...
						<div class="row">
							<div class="col-xl-8 col-lg-12 col-md-12 d-block mx-auto">
								<div class="text-center text-white text-property">
									<h1 ><span class="font-weight-bold"><?php echo $city_name?></span></h1>
								</div>
							...
							<div class="item2-gl ">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="tab-11">
									    <?php
									    $query="SELECT * FROM property_details WHERE status='Active' AND location='$city_id' ";
        		    ...
        		    $property_image=get_first_image($property_id);
										...
										<div class="card overflow-hidden">
										    ...
										    foreach($facilities_arr as $arr){
										        ...
										        echo'
										        <a href="#" class="icons text-muted">'.$arr.'&nbsp;|&nbsp;</a>
										        ';
										    }
															    ?>
