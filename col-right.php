					...
					<div class="col-xl-4 col-lg-4 col-md-12">
						<div class="card">
							...
							<div class="card-body item-user">
								...
								<div>
									<h6><span class="font-weight-semibold"><i class="fa fa-map-marker mr-2 mb-2"></i></span><a href="#" class="text-body">The Avenue, 3rd Floor,
Unit No.303, Airport Road,
Opp.Hotel Leela,Marol,
Andheri (E)
Mumbai-400059,
Maharashtra, India.
</a></h6>
