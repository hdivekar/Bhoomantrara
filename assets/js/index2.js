$(function(e){
 ...
 var ctx = document.getElementById( "lineChart1" );
            ...
            datasets: [
                {
                    ...
                    borderWidth: "5",
                    backgroundColor: "rgba(237, 81, 81, 0.6)",
	...
	gradientStroke1.addColorStop(0, 'rgba(237, 81, 81 ,0.3)');

	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 190);
	gradientStroke2.addColorStop(0, 'rgba(156, 49, 223,0.3)');
	...
	gradientStroke1.addColorStop(0, 'rgba(237, 81, 81 ,0.8)');

	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 300);
	gradientStroke2.addColorStop(0, 'rgba(156, 49, 223,0.8)');
	var myChart = new Chart(myCanvas, {
		type: 'bar',
		data: {
